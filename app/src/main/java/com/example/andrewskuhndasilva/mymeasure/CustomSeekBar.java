...
public class CustomSeekBar extends View {
        ...
        private void drawLine(Canvas canvas) {
            ...
            for (int i = 0; i <= count; i++) {
                ...
                if (i % 15 == 0) {
                    ...
                    if (mIsShowMark) {
                        canvas.drawText(
                                (int) (Angle2Progress(i * 3 + mStartAngle)) + " °C",
                                mCenter - 15 * mMinSize,
                                top - 10 * mMinSize,
                                mTextPaint);
                    }
        ...
        private void drawText(Canvas canvas) {
            ...
            if (mIsShowProgress) {
                canvas.drawText(String.format("%.2f °C", mProgress),
                        mCenter - 30 * mMinSize,
                        mCenter,
                        mTextPaint);
            }
        ...
        public interface OnSeekArcChangeListener {
            ...
            void onProgressChanged(CustomSeekBar seekArc, float progress);

            void onStartTrackingTouch(CustomSeekBar seekArc);

            void onStopTrackingTouch(CustomSeekBar seekArc);
        }
